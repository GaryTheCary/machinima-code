...
//creating a script to control the camera in : zooming(scolling) & direction(moving)

public class CameraRotate : MonoBehaviour
{
	//varibles to find target which camera will look at
	...
	void LateUpdate()
	{  
		//get mouse info and scale change accordingly
